...
alter table i2_no001 alter column c_smallint
...
case 014 "数据：数字类型重命名表" 0

before:
drop table dbo.i2_no006;
drop table i2_no006_renew;
go
src_sql:
...
exec sp_rename 'dbo.i2_no006','i2_no006_renew';
insert into i2_no006_renew values ( 3,300,55,30000,50003,-654.54,876543.2398, 300.45, 500.6789, -100.23, -300.45,1);
insert into i2_no006_renew(no,c_int,c_smallint,c_bigint) values (4,400,10004,50004);
update dbo.i2_no006_renew set c_smallint=79,c_decimal=456.12,c_smallmoney=13 where no=2;
update dbo.i2_no006_renew set c_real=111.89 where no=4;
delete from i2_no006_renew where no=1;
go
...
create table dbo.i2_no008 (
    ...
    c_smallmoney   smallmoney,
	c_bit		   bit,
	constraint pk_idno008 primary key(no),
	constraint qu_bigno008 unique(c_bigint)
);
