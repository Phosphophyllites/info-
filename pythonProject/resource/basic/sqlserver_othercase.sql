...
select name,xtype from sys.sysobjects where parent_obj= OBJECT_ID('sparsetable2') order by name;
...
select name,xtype from sys.sysobjects where parent_obj= OBJECT_ID('sparsetest1') order by name;
...
select name,xtype from sys.sysobjects where parent_obj= OBJECT_ID('sparsetest2') order by name;
...
select name,xtype from sys.sysobjects where parent_obj= OBJECT_ID('sparsetest3') order by name;
