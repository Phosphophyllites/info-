...
select name,xtype from sys.sysobjects where parent_obj= OBJECT_ID('i2_text001') order by name;
...
select name,xtype from sys.sysobjects where parent_obj= OBJECT_ID('i2_text002') order by name;
...
select name,xtype from sys.sysobjects where parent_obj= OBJECT_ID('i2_text003') order by name;
...
select name,xtype from sys.sysobjects where parent_obj= OBJECT_ID('i2_text004') order by name;
...
select name,xtype from sys.sysobjects where parent_obj= OBJECT_ID('i2_text005') order by name;
...
select name,xtype from sys.sysobjects where parent_obj= OBJECT_ID('i2_text006_新表') order by name;
...
select name,xtype from sys.sysobjects where parent_obj= OBJECT_ID('i2_text007') order by name;
...
select name,xtype from sys.sysobjects where parent_obj= OBJECT_ID('i2_text008') order by name;
