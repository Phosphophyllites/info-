...
select name,xtype from sys.sysobjects where parent_obj= OBJECT_ID('i2_xml001') order by name;
...
select name,xtype from sys.sysobjects where parent_obj= OBJECT_ID('i2_xml002') order by name;
...
select name,xtype from sys.sysobjects where parent_obj= OBJECT_ID('i2_xml003') order by name;
...
select name,xtype from sys.sysobjects where parent_obj= OBJECT_ID('i2_xml004') order by name;
...
select name,xtype from sys.sysobjects where parent_obj= OBJECT_ID('i2_xml005') order by name;
...
select name,xtype from sys.sysobjects where parent_obj= OBJECT_ID('i2_xml006_新表') order by name;
...
select name,xtype from sys.sysobjects where parent_obj= OBJECT_ID('i2_xml007') order by name;
